...
class NN(): 
    ...
    def backward(self):
        ...
        #print(np.shape(self.placeholder["y"]))
        ...
        self.grad_h2 = np.dot(self.grad_a3, self.W3.T)
        self.grad_a2 = np.multiply(self.a2.clip(0,1), self.grad_h2)
        self.grad_b2 = np.ones((n, 1)).T.dot(self.grad_a2)
        self.grad_W2 = self.h1.T.dot(self.grad_a2)
        self.grad_h1 = np.dot(self.grad_a2, self.W2.T)
        self.grad_a1 = np.multiply(self.a1.clip(0, 1), self.grad_h1)
